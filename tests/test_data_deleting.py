...
def test_data_deleting_other_user_as_root(
    my_data: MyData, root_user: User, test_normal_user_to_delete: User
) -> None:
...
def test_data_deleting_tags_as_root(
    my_data: MyData, root_user: User, test_tag_to_delete: Tag
) -> None:
...
def test_data_deleting_tags_as_normal_user(
    my_data: MyData, normal_user_1: User, test_tag_to_delete: Tag
) -> None:
    """Test deleting tags as the root user.
...
def test_data_deleting_api_clients_as_root(
    my_data: MyData, root_user: User, test_api_client_to_delete: APIClient
) -> None:
...
def test_data_deleting_api_clients_as_normal_user(
    my_data: MyData, normal_user_1: User, test_api_client_to_delete: APIClient
) -> None:
    """Test deleting API clients as the root user.
...
def test_data_deleting_api_tokens_as_root(
    my_data: MyData, root_user: User, test_api_token_to_delete: APIToken
) -> None:
    """Test deleting API clients as the root user.
...
def test_data_deleting_api_tokens_as_normal_user(
    my_data: MyData, normal_user_1: User, test_api_token_to_delete: APIToken
) -> None:
...
def test_data_deleting_user_settings_as_root(
    my_data: MyData, root_user: User, test_user_setting_to_delete: UserSetting
) -> None:
...
def test_data_deleting_user_settings_as_normal_user(
    my_data: MyData,
    normal_user_1: User,
    test_user_setting_to_delete: UserSetting,
) -> None:
